...
# cat(theta[3] / theta[2], theta[4] / theta[2])
# theta = c(0.15, 1 / 7, 0.78, 0.78 * 0.3, 0.78 * 0.16)
theta = c(theta[1], 1/7, theta[2:7])
...
simu.plot.res.path = "/Users/mac/Desktop/CHIL_code/SEIR/out/simu_res/GSEIR_new_plotres.RDS"
simu.res.path = "/Users/mac/Desktop/CHIL_code/SEIR/out/simu_res/GSEIR_new.RDS"
...
figure_3_filename = paste(main_path,"/", "Pareto_SEIR.png", sep = "")
